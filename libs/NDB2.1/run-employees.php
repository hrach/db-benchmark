...
$dao = new Context(
    $connection,
    new DiscoveredReflection($connection, Bootstrap::$config['cache'] ? $cacheStorage : NULL),
    Bootstrap::$config['cache'] ? $cacheStorage : NULL
);
...
Bootstrap::result('NDB 2.1', 'Nette: ' . Framework::VERSION, $startTime, $endTime);
