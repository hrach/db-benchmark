...
$connection->setCacheStorage(Bootstrap::$config['cache'] ? $cacheStorage : NULL);
$connection->setDatabaseReflection(new DiscoveredReflection(Bootstrap::$config['cache'] ? $cacheStorage : NULL));
$dao = $connection;
...
Bootstrap::result('NDB 2.0', 'Nette: ' . Framework::VERSION, $startTime, $endTime);
